...
// const cycling1 = new Cycling([ 37, -12 ], 27, 95, 523);
...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === 'cycling') {
      const elevation = +inputElevation.value; // convert string to a number
      if (
  ...
  _moveToPopup(e) {
    ...
    const workout = this.#workouts.find(
      work => work.id === workoutEl.dataset.id.trim()
    );
  ...
  // incase we we want to remove the data from local storage
  reset() {
